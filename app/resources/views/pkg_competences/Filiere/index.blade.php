@extends('layouts.app')
@section('title', __('pkg_competences/Filiere.singular'))
                ...
                <div class="col-sm-6">
                    <h1>
                        @php
                            ...
                            $translatedName = TranslationHelper::getTitle(__('pkg_competences/Filiere.plural'), $lang);
                            echo $translatedName;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        @include('pkg_competences.Filiere.table')
                    </div>
                </div>
            </div>
        </div>
