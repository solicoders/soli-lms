<form action="{{ $dataToEdit ? route('Filiere.update', $dataToEdit->id) : route('Filiere.store') }}" method="POST">
    @csrf
    @if ($dataToEdit)
        @method('PUT')
    @endif
    ...
    <div class="card-footer">
        <a href="{{ route('Filiere.index') }}" class="btn btn-default">{{ __('app.cancel') }}</a>
