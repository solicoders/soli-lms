@extends('layouts.app')
@section('title', __('app.show') . ' ' . __('pkg_competences/Module.singular'))
@section('content')
        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                @can('edit-ModuleController')
                    <div class="col-sm-6">
                        <a href="{{ route('Module.edit', $fetchedData->id) }}" class="btn btn-default float-right">
